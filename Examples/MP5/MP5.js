...
function startup() {
  ...
  // Set up event listeners For clicking and moving the mouse.
 ...
 */
function mouseDown() {
  console.log("The left mouse button was pressed.");
}


/**
 * Callback function called when the mouse is released.
 */
function mouseUp() {
  console.log("The left mouse button was released.");
}